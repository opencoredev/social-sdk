---
title: Integrations
description: Use Social SDK with Next.js, Convex, Supabase, Neon, Express, Hono, Elysia, NestJS, TanStack Start, Trigger.dev, Inngest, and other TypeScript stacks.
---
