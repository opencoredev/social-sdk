...
The native module covers polls, reactions, reshares, updates, deletion, and organization analytics. Multi-image posts go through `social.posts.publish`. Video and document posts are not supported yet. Articles remain approval dependent.
