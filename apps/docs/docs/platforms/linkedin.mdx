...
The native module covers polls, reactions, reshares, updates, deletion, comment deletion, and organization analytics. Multi-image, video, and document posts are not supported yet. Articles remain approval dependent.
