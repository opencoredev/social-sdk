...
The native module covers polls, reactions, reshares, updates, deletion, video and document status checks, and organization analytics. Multi-image, video, and document posts go through `social.posts.publish`. Articles remain approval dependent.
