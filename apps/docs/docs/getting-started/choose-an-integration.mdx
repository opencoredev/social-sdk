...
| Postiz      | You want Postiz Cloud or your own self-hosted Postiz to post now or on a schedule.                           | A Postiz workspace and key, tenant mapping, and plan charges or your own hosting.                    |
